export default {
  ...
  login: {
    account: '계좌번호',
    accountPlaceholder: '계좌번호를 입력하십시오(휴대폰 번호)',
    accountError: '계좌번호를 입력하십시오(휴대폰 번호)',
    password: '비밀번호',
    passwordPlaceholder: '비밀번호를 입력하십시오',
    // 密码长度最少为
    passwordError: '비밀번호를 입력하십시오(비밀번호 길이는 최소 6 자리여야 함)',
    phone: '휴대폰 번호',
    phonePlaceholder: '휴대폰 번호를 입력하십시오',
    code: '인증 코드',
    codePlaceholder: '인증 코드를 입력하십시오',
    getCode: '인증 코드 받기',
    login: '로그인',
  },
}
