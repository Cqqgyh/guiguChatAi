export default {
  ...
  login: {
    account: 'Account',
    accountPlaceholder: 'Please enter your account(phone number)',
    accountError: 'Please enter your account(phone number)',
    password: 'Password',
    passwordPlaceholder: 'Please enter your password',
    // 密码长度最少为6位
    passwordError: 'The minimum password length is 6 digits',
    phone: 'Phone',
